...
namespace GameWatcher.Controllers
{
    public class ChannelsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ChannelId,ChannelName")] Channel channel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ChannelId,ChannelName")] Channel channel)
        {
            if (ModelState.IsValid)
            {
